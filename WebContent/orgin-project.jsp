...
<form class="orgin-form" action="OrginProjectServlet" method="post">

	<div class="line">
		项目名称：<input class="line-input project-title" type="text" name="project_title" placeholder="项目名称"/>
	</div>
	<div class="line">筹资金额：<input class="line-input project-money" type="number" name="project_money" placeholder="筹资金额"/></div>
	<div class="line">募集天数：<input class="line-input project-days" type="number" name="project_days" placeholder="募集天数"/></div>
	<div class="line">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：
	...
	<div class="line" style="  text-indent: 0px;">
		项目简介：
		<textarea class="line-textarea" name="project_description" placeholder="项目简介" style="resize:none;"></textarea>
	</div>
...
<div class="line" style="  text-indent: -500px;  margin-bottom: -35px; margin-top: 60px;">
	项目详情：
	<input class="project-content" type="hidden" name="project_content" value=""/>
</div>
...
<div class="content-right">
	...
	<div class="image-display">项目封面</div>
	<div class="title"></div>
	<div class="taget days">目标：</div>
	<div class="taget money"></div>
</div>
</div>
</div>
...
<script>
 ...
 //表单验证
 	...
 	$(".orgin-form").validate({
  	...
  	$(".project-money").blur(function(){
		$(".money").html("￥ "+$(this).val());
	  	});

  	$(".project-days").blur(function(){
		$(".days").html("目标："+$(this).val()+"天");
	  	});
